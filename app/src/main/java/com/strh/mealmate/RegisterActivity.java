                        ...
                        if (task.isSuccessful()) {
                            ...
                            db.collection("users").document(uid)
                                    ...
                                    .addOnSuccessListener(unused -> {
                                        Toast.makeText(this, "Registered & profile created", Toast.LENGTH_SHORT).show();
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(RegisterActivity.this, "Google login failed", Toast.LENGTH_SHORT).show();
                    }
                });
    }
